                ...
                return _editCommand ?? (_editCommand = new RelayCommand<IClosable>(async (window) =>
                {
                    if (Category != null && Category != "")
                    {
                        using (DatabaseContext database = new DatabaseContext())
                        {
                            ...
                            {
                                if (database.Income_Types.ToList().Find(x => x.Name == Category && x.Id != _id) == null)
                                {
                            ...
                            {
                                if (database.Expense_Types.ToList().Find(x => x.Name == Category && x.Id != _id) == null
                                ...
                                {
                                    await AdditionalFunctions.CallModalMessage("Ошибка", "Такое название категории или подкатегории уже существует!");
                                }
                            }
                        }
                    }
